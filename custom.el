...
(custom-set-faces
 ...
 '(org-agenda-date ((t (:background "#eeeeee" :foreground "#1662AF" :weight bold :box t :height 1.1))))
 '(org-agenda-date-today ((t (:background "#F2FCFF" :foreground "#1662af" :box t :weight bold :height 1.3))))
