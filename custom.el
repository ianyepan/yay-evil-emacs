...
(custom-set-faces
 ...
 '(linum ((t (:background "#FCF6E2" :foreground "#888888"))))
 ...
 '(nlinum-relative-current-face ((t (:inherit linum :background "#FCF6E2" :foreground "#000000" :weight normal))))
 '(mode-line ((t (:background "#EDE8D5" :foreground "#839496" :box (:line-width 2 :color "#777" :style released-button)))))
 '(org-agenda-date ((t (:foreground "#1662AF" :weight bold :height 1.3))))
 '(org-agenda-date-today ((t (:background "#FFFFCC" :foreground "#4F4A3D" :weight bold :height 1.3))))
 '(org-agenda-date-weekend ((t (:foreground "#4E4E4E" :weight bold :height 1.3))))
 '(org-document-title ((t (:height 2.0 :family "CMU Serif"))))
 '(org-block ((t (:background "#002b36" :foreground "#B4B9BD"))))
 '(outline-1 ((t (:background "#E2E9ED" :foreground "#405070" :overline t :weight bold :height 1.3))))
 '(outline-2 ((t (:background "#FFECE6" :foreground "#704040" :overline t :weight bold :height 1.2))))
 '(outline-3 ((t (:background "#E9E6F1" :foreground "#493e69" :overline t :weight bold :height 1.1))))
