...
(custom-set-faces
 ...
 '(outline-1 ((t (:background "#E4F2FF" :overline t :weight bold :height 1.3))))
 '(outline-2 ((t (:background "#FFE7E4" :overline t :weight bold :height 1.2))))
 '(outline-3 ((t (:background "#EAE4FF" :overline t :weight bold :height 1.1))))
 '(region ((t (:background "#E3D8BB"))))
