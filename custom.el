...
(custom-set-faces
 ...
 '(org-level-1 ((t (:background "#E4F2FF" :foreground "#0E3A6D" :overline t :weight bold :height 1.3))))
 '(org-level-2 ((t (:background "#FFE7E4" :foreground "#801111" :overline t :weight bold :height 1.2))))
 '(org-level-3 ((t (:background "#EAE4FF" :foreground "#1C1180" :overline t :weight bold :height 1.1))))
