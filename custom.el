...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (column-enforce-mode evil magit whitespace-cleanup-mode smooth-scrolling smex rainbow-mode org-bullets ido-vertical-mode highlight-operators highlight-numbers highlight-escape-sequences flycheck auto-indent-mode))))
(custom-set-faces
