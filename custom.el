...
(custom-set-faces
 ...
 '(mode-line ((t (:background "#dddddd" :foreground "#000000" :box (:line-width 2 :color "#777" :style released-button)))))
 '(mode-line-inactive ((t (:inherit mode-line :background "#aaaaaa" :foreground "#000000"))))
